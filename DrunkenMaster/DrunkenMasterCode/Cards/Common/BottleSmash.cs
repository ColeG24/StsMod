...
/// <summary>1 Energy + 1 Intoxication. Deal 10 damage. Apply 1 Weak. Upgraded: 13 and 2 Weak.</summary>
public class BottleSmash : DrunkenMasterCard
{
    public const int IntoxicationCost = 1;
    public BottleSmash() : base(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
